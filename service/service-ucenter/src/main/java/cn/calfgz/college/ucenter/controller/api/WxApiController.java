...
import cn.calfgz.college.common.util.HttpClientUtils;
...
import cn.calfgz.college.ucenter.util.ConstantPropertiesUtil;
...
public class WxApiController {
    ...
    public String callback(String code, String state){
        ...
        String result = null;
        try {
            result = HttpClientUtils.doGet(accessTokenUrl);
        ...
        if(member == null){
            ...
            try {
                resultUserInfo = HttpClientUtils.doGet(userInfoUrl);
